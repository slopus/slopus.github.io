# Hidden harness preview: discarded interaction sketches

These are reference notes, not planned or enabled features. The current page
keeps its copy short and its interactions tied to hover, keyboard focus, or tap.

- Page-edge paper peel / sticker fold: removed. The Croodles teammate simply
  appears with `LGTM`, and the speech bubble sits above the artwork.
- Alternating `i saw that` / `have you thought about doing it this other way?`:
...
headings remain keyboard accessible, and touch can activate the whole row.