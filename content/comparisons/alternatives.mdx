...
**Claudia** is a YC startup offering a desktop coding agent with AGPL licensing as a channel to their paid services.

**Key Differences:**
- **Business Model**: Claudia uses AGPL as a sales funnel for paid tiers. Happy is truly free.
