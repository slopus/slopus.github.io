const standard = {
  framerate: 30,
  desktop: { src: '/video/happy-one/v22/desktop-30.mp4', width: 1560, height: 1328 },
  phone: { src: '/video/happy-one/v22/phone-30.mp4', width: 804, height: 1748 },
} as const

const highQuality = {
  framerate: 60,
  desktop: { src: '/video/happy-one/v22/desktop.mp4', width: 1950, height: 1660 },
  phone: { src: '/video/happy-one/v22/phone.mp4', width: 1206, height: 2622 },
} as const
