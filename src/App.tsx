...
const GITHUB_HAPPY = 'https://github.com/slopus/happy'
const WEB_APP = 'https://app.happy.engineering'
...
function Wordmark() {
  return (
    <a className="wordmark" href="#top" aria-label="Happy Engineering home">
    ...
    <div className="site-shell">
      <header className="site-header page-width" id="top">
        ...
        <nav aria-label="Primary navigation">
          <a href={APP_STORE_LINK}>iOS App</a>
          <a href={GOOGLE_PLAY_LINK}>Android App</a>
          <a href="https://happy.engineering/docs">Docs</a>
          <a className="nav-github" href={GITHUB_HAPPY} aria-label="Happy on GitHub — 22,000+ stars">
          ...
          <a className="nav-cta" href={WEB_APP}>
            Happy Web
          </a>
        </nav>
      </header>
      ...
      <main>
        ...
        <section className="closing page-width" aria-labelledby="closing-heading">
          ...
          <div className="hero-actions closing-actions">
            <a className="button button-ghost" href={WEB_APP}>
              Open Web App
            </a>
          </div>
        </section>
