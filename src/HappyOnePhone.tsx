...
export function HappyOnePhone({ video, focused, inspecting, inspect }: Props) {
  ...
  return (
    <button ref={host} type="button" className="one-demo-phone" aria-label="Take a closer look at the iPhone"
